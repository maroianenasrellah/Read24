                        ...
                        if(DATE_TODAY == DATE_LAST_PASS):
                            ...
                            if bOK == True:
                                ...
                                try:
                                    ...
                                    msg("CONSO JOUR:"+str(NBR_SEAUX_MAX-CONSO_JOUR)+"/"+str(NBR_SEAUX_MAX),"Patienter..")
                                    time.sleep(2)
                                    msg("RESTE : "+str(CREDIT_TOTAL-CONSO_TOTAL)+"/"+str(CREDIT_TOTAL),"Patienter...")
                                    time.sleep(2)
                                    #deconection de la carte
                                    MIFAREReader.MFRC522_StopCrypto1()
                                    
                                    t1 = threading.Thread(name='t1',target= declencherelay).start()
                                    msg("Recupurer ","les Balles")
                                    time.sleep(2)
                                    print("\n")
